 ...
 *   https://datatables.net/download/#bs5-5.3.0/jq-3.7.0/dt-2.3.1/r-3.0.4
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, jQuery 3.7.0, DataTables 2.3.1, Responsive 3.0.4
 */
...
(function (global, factory) {
  ...
  */
  ...
  class Dropdown extends BaseComponent {
    constructor(element, config) {
      super(element, config);
      this._popper = createPopper({}, this._menu, this._getPopperConfig());
    //   this._popper = null;
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5-5.3.0/jq-3.7.0/dt-2.3.1/r-3.0.4",
